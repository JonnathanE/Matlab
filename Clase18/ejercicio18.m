...
T = table(x(:),y(:),yE(:),yH(:),yRK(:),errEuler(:),errHeun(:),errRunge(:),...
    'VariableNames',{'x','y','Euler','Heun','Runge_Kutta_4','Error_Euler','Error_Heun','Error_Runge_Kutta_4'})
% Gráfica
% y = red circle; Euler = blue, Heun = green, Rnge_kutta_4 = yellow
plot(T.x,T.y,'r',T.x, T.Euler,'b', T.x, T.Heun,'g',T.x, T.Runge_Kutta_4,'y')
legend('Exacta','Euler','Heun','Runge')
